...
import { loginStyle as style, requestLeave as rstyle } from '../../../assets/styles';
import { GoogleConfig } from '../../utils';
import { signInApple, signInGoogle, getLogin, createUser } from '../../services';
...
const Login = () => {
  const [showLoginForm, setLoginForm] = useState(Platform.OS === 'ios' ? true: false);
  ...
  const submitLogin = (values: any) => {
    ...
    if (values.EmailAddress === 'dev@noveltytechnology.com' && values.Password === 'testPassword') {
      ...
      const user = {
        ...
        image_url: 'https://lh5.googleusercontent.com/-x6GB2ApSCXU/AAAAAAAAAAI/AAAAAAAAAAA/AMZuucnhtcm9X9UWnHBQpR4YP9h7d9uPfw/s120/photo.jpg',
  ...
  return (
    <LoginWrapper>
      <View style={style.buttonView}>
        {showLoginForm && <View style={style.formWrapper}>
          <Formik
                  ...
                  <Fragment>
                    ...
                    <Button onPress={() => handleSubmit()} >
                      <View style={rstyle.buttonView}>
                        <Text style={[rstyle.buttonText, { paddingVertical: 10 }]}>Login</Text>
                      </View>
                    </Button>

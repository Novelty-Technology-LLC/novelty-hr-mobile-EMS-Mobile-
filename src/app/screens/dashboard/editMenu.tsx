...
import { dashboardStyle, headerTxtStyle, listingStyle } from '../../../assets/styles';
...
export const EditMenu = ({ navigation, route }: any) => {
    ...
    const onSubmit = () => {
        setIsLoading(true);
        menuServices.editMenu(item.id, menuText).then(() => {
            dispatchMenu({ type: 'UPDATE_ITEM', payload: { id: item.id, value: menuText } });
                        ...
                        {(props) => {
                            return <>
                                ...
                                <CustomButton
                                    ...
                                    disabled={menuText.trim() == item.title.trim() || menuText.trim() == ''}
                                    isLoading={isLoading}
                                />
                            </>
                        }}

...
export const EditEmployeeDetail = ({ route, navigation }: any) => {
    ...
    const transformDesignations = (designationsFromAPi: any[]): DropDownItem[] => {
                    ...
                    >
                        {(props) => {
                            return <View style={{}}>
                                ...
                                <View style={editEmployeeStyles.horizontalView}>
                                    <>
                                        <DialogContainer visible={isBDCVisible} setVisible={setBDCVisible}>
                                            <>
                                                ...
                                                <Calendar
                                                    ...
                                                    onSelect={(date) => {
                                                        setBirthDate(date);
                                                        props.handleChange('birth_date')(moment(date).format('ll'))
                                                        setBDCVisible(false);
                                                    }}
                                                />
                                            </>
                                        </DialogContainer>
                                        <Pressable onPress={() => setBDCVisible(true)}
                                            style={editEmployeeStyles.horizontalViewItem}
                                        >
                                            <CustomTextInput
                                ...
                                {/* Join Date */}
                                <>
                                    <DialogContainer visible={isJDCVisible} setVisible={setJDCVisible}>
                                        <>
                                            ...
                                            <Calendar
                                                ...
                                                onSelect={(date) => {
                                                    setJoinDate(date);
                                                    props.handleChange('join_date')(moment(date).format().slice(0, 10))
                                                    setJDCVisible(false);
                                                }}
                                            />
                                        </>

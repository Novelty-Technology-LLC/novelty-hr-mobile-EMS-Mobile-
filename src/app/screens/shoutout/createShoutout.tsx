...
import { dashboardStyle, fonts, headerTxtStyle, listingStyle, theme } from '../../../assets/styles';
            ...
            >
                ...
                >
                    {(props) => {
                        return (
                            <>
                                <Text style={[textStyles.title, { marginBottom: normalize(theme.size.sm) }]}>
                                    Give a shoutout to {employee.title}
                                </Text>
                                <View style={{ height: normalize(141) }}>
                                    <CustomTextInput
